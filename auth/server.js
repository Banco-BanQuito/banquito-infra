...
const REQUIRED_VARS = ['JWT_SECRET', 'JWT_ISS', 'ADMIN_PASSWORD', 'TELLER_PASSWORD', 'EMPRESA_PASSWORD', 'CLIENTE_PASSWORD', 'EMPRESA1_RUC'];
...
const USERS = process.env.AUTH_USERS
  ...
  : {
      ...
      [EMPRESA1_RUC]:       { password: process.env.EMPRESA_PASSWORD, role: 'empresa' },
