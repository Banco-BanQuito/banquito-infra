...
| --- | --- | ---: | ---: | --- |
| `banquito-file-reception-service` | Spring Boot / Maven | 8084 | cliente | MySQL `filedb`, MongoDB, RabbitMQ |
...
clearinghouse-service -> RabbitMQ
...
| Bases, RabbitMQ, OAuth, SMTP | Servicios administrados o externos |
