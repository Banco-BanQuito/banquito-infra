...
- A favor: un fallo temporal en el Core (ver ADR-004 de Fase 1) no tira el archivo completo — cada línea fallida se reporta individualmente sin afectar a las demás.
