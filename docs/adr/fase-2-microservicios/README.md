...
| [006](006-particionamiento-postgresql.md) | Particionamiento de transacciones en PostgreSQL |
...
| [009](009-consistencia-compensacion.md) | Consistencia entre microservicios vía transacción compensatoria |
| [010](010-idempotencia-transacciones.md) | Idempotencia de operaciones financieras con un identificador único de transacción |
...
> **Nota de revisión:** el ADR-006 (particionamiento) documenta la partición por fecha de transacción. Una verificación en vivo contra la base de datos real durante el desarrollo de Fase 3 confirmó que la columna que efectivamente se usa para descartar particiones es la fecha contable — son dos columnas distintas del mismo modelo. Pendiente de confirmar con el autor original si esto es un error de documentación o si el esquema cambió después de escrito el ADR.
