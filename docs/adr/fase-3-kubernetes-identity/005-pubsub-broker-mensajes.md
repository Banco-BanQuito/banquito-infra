...
- Con esta opción, la entrega de mensajes es "al menos una vez" — un mensaje puede llegar duplicado en algunos casos. Esto hace todavía más importante el control de duplicados que el Core ya exigía desde el primer parcial mediante un identificador único de transacción, que ahora es la última línea de defensa contra un pago duplicado.
