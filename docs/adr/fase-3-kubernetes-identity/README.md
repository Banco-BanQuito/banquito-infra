...
> **Nota:** se quitó el ADR de autoescalamiento (HPA) que se había agregado: los valores (70% CPU, 80% memoria, 1 a 3 réplicas) son parámetros de configuración razonables, pero no hay evidencia de que el equipo haya debatido en serio una alternativa real — no calificaba como decisión de arquitectura, solo como ajuste técnico.
